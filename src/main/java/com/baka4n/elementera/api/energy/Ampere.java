...
public class Ampere implements Electric {
    protected int energy;
    protected int capacity;
    protected int maxReceive;
    protected int maxExtract;

    public Ampere(int capacity, int maxReceive, int maxExtract) {
        this.capacity = capacity;
        this.maxReceive = maxReceive;
        this.maxExtract = maxExtract;
    }

    public Ampere(int capacity, int maxTransfer) {
        this(capacity, maxTransfer, maxTransfer);
    }

    public Ampere(int capacity) {
        this(capacity, capacity, capacity);
    }

    public Ampere readNbt(CompoundNBT nbt) {
        this.energy = nbt.getInt("ampere");
        if (energy > capacity)
                energy = capacity;
        return this;
    }
